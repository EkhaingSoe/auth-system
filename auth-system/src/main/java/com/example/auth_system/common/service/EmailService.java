...
public class EmailService {
    ...
    // String body = String.format("Click the link below to reset your
    ...
    // String body = "Your password has been successfully reset. If you didn't
    // perform this action, please contact support immediately.";
