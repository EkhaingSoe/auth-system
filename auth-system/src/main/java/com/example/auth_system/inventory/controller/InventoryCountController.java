...
@RestController
@RequestMapping("/api/admin/inventory-counts")
...
public class InventoryCountController {
        ...
        @PostMapping("/{countId}/create-adjustment")
        public ResponseEntity<ApiResponse<List<StockAdjustmentResponse>>> createAdjustment(
                        @PathVariable UUID countId) {

                List<StockAdjustmentResponse> response = inventoryCountService.createAdjustment(countId);
