...
public class StockAdjustmentMapper {
        ...
        public StockAdjustmentResponse toResponse(StockAdjustment stockAdjustment) {
                ...
                return StockAdjustmentResponse.builder()
                                ...
                                .variantId(stockAdjustment.getVariant() != null ? stockAdjustment.getVariant().getId()
                                                : null)
                                .variantSku(stockAdjustment.getVariant() != null ? stockAdjustment.getVariant().getSku()
                                                : null)
                                .variantAttributes(
                                                stockAdjustment.getVariant() != null
                                                                ? stockAdjustment.getVariant().getAttributeValues()
                                                                : null)
