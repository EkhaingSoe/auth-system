...
public class StockMovementController {
    ...
    // log.info("GET /api/inventory/movements/product/{} - Getting movements by
    // product",
    // productId);
    ...
    // log.info("GET /api/inventory/movements/warehouse/{} - Getting warehouse
    // movements",
    // warehouseId);
    ...
    // // stockMovementService.transferStock(request);
    ...
    // @PreAuthorize("@permission.hasPermission('INVENTORY_VIEW')")
    // public ResponseEntity<ApiResponse<Object>> getMovementSummary(
    // @PathVariable UUID productId) {
